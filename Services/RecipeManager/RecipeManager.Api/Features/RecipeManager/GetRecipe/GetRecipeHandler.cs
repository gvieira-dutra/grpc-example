...
public sealed record GetRecipeQuery(string RecipeName) : IRequest<GetRecipeResult>;

public sealed record GetRecipeResult(
    string RecipeName,
...
{
    public async Task<GetRecipeResult> Handle(
